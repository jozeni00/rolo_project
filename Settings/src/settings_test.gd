...
@onready var soundsection := $CanvasLayer/Panel/ScrollContainer/VBoxContainer/Sounds
@onready var displaysection := $CanvasLayer/Panel/ScrollContainer/VBoxContainer/Displays
@onready var keybindsection := $CanvasLayer/Panel/ScrollContainer/VBoxContainer/Keybinds/KeyBindButtons
