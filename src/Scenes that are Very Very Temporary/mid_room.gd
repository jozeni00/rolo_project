...
@onready var topZone = load("res://src/Scenes that are Very Very Temporary/sharkoRoom.tscn")
@onready var bottomZone = load("res://src/Scenes that are Very Very Temporary/farmRoom.tscn")
